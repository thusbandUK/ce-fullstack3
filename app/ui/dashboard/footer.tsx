        ...
        <div className="mt-[40]">
          <footer className="footer footer-horizontal footer-center bg-neutral text-neutral-content rounded p-10">
            ...
            <div className="grid grid-flow-col gap-4">
                {/*instagram logo, from: https://icons.getbootstrap.com/icons/instagram/ see manual */}
                <a>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="fill-current" viewBox="0 0 16 16">
